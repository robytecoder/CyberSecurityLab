...
![Oopsie HTB](images/cover.png)

This is a detailed walkthrough for the **Oopsie** machine on Hack The Box (HTB).
...
1. Tap **Use this template** in the template repository (upper-right green button) and then choose **Create a new repository**
